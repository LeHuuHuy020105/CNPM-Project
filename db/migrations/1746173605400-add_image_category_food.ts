...
export class AddImageCategoryFood1746173605400 implements MigrationInterface {
    name = 'AddImageCategoryFood1746173605400'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`categories\` ADD \`image\` longblob NOT NULL`);
