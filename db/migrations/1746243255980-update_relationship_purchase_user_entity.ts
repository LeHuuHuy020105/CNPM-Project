...
export class UpdateRelationshipPurchaseUserEntity1746243255980 implements MigrationInterface {
    name = 'UpdateRelationshipPurchaseUserEntity1746243255980'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`purchase_orders\` ADD \`userId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`suppliers\` CHANGE \`description\` \`description\` varchar(255) NOT NULL`);
