...
export class DeleteStatusTable1746587721981 implements MigrationInterface {
    name = 'DeleteStatusTable1746587721981'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`tables\` ADD \`status\` enum ('EMPTY', 'OCCUPIED') NOT NULL DEFAULT ''EMPTY''`);
