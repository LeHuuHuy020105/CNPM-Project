...
export class UpdateFieldImageEntityFoodCategory1746174994490 implements MigrationInterface {
    name = 'UpdateFieldImageEntityFoodCategory1746174994490'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`categories\` CHANGE \`avatar\` \`image\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`food_items\` CHANGE \`avatar\` \`image\` varchar(255) NULL DEFAULT 'NULL'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`food_items\` DROP COLUMN \`image\``);
        await queryRunner.query(`ALTER TABLE \`food_items\` ADD \`image\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`food_items\` ADD CONSTRAINT \`FK_bf31353b77c5507183f82b7a28a\` FOREIGN KEY (\`category_id\`) REFERENCES \`categories\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`categories\` DROP COLUMN \`image\``);
        await queryRunner.query(`ALTER TABLE \`categories\` ADD \`image\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`food_items\` CHANGE \`image\` \`avatar\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`categories\` CHANGE \`image\` \`avatar\` varchar(255) NULL DEFAULT 'NULL'`);
    }
