...
export class UpdateDb1746363263981 implements MigrationInterface {
    name = 'UpdateDb1746363263981'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`nameCustomer\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP COLUMN \`phoneCustomer\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`phoneCustomer\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`orders\` ADD \`nameCustomer\` varchar(255) NULL DEFAULT 'NULL'`);
    }
